...
local config = {
	...
	model = "models/antlion.mdl", // What should the model be?
	owner = nil, // DONT TOUCH

	idleAnimation = "Idle", // What animation do we use for idling?
	walkAnimation = "walk_all", // What animation do we use for walking?
	runAnimation = "RunAgitated", // What animation do we use for running?
	attackAnimation = "pounce", // What animation do we use for attacking?
